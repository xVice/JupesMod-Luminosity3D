...
namespace Luminosity3D.BloomStages
{
    ...
    public class BloomFirstStage
    {
        ...
        {
            mDownsampleShader = new ShaderProgram("./shaders/builtin/shadersBloom/bloom.vert", "./shaders/builtin/shadersBloom/downscale.frag");
            mUpsampleShader = new ShaderProgram("./shaders/builtin/shadersBloom/bloom.vert", "./shaders/builtin/shadersBloom/upscale.frag");
        ...
        private void RenderUpSamples(float FilterRadius)
        {
            ...
            for(int i = mMipChain.Length - 1; i > 0; i--)
            {
                ...
                mUpsampleShader.SetUniform("uGhosts", 0);
                mUpsampleShader.SetUniform("uGhostDispersal", 0);
