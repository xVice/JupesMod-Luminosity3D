...
namespace MyGame
{
    public class Particles : IDisposable
    {
        ...
        {
            shader = new ShaderProgram("Rendering/Samplers/Particles/shader.vert", "Rendering/Samplers/Particles/shader.frag");
            ...
            float radius = SceneManager.ActiveScene.activeCam.DistanceOfView - 300f;
        ...
        public void RenderFrame()
        {
            ...
            shader.SetUniform("moving", SceneManager.ActiveScene.activeCam.Position);
