    ...
    public class Stencil
    {
        ...
        public void RenderFrame(Matrix4 model, System.Numerics.Vector4 color) 
        {
            if(RenderStencil)
            {
                ...
                shaderStencil.SetUniform("view", SceneManager.ActiveScene.activeCam.ViewMatrix);
                shaderStencil.SetUniform("projection", SceneManager.ActiveScene.activeCam.ProjectionMatrix);
