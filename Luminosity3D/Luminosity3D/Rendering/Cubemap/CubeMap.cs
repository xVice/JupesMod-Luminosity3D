...
namespace MyGame
{
    ...
    public class CubeMap
    {
        ...
        private ShaderProgram shaderRender = new ShaderProgram("Rendering/Cubemap/shaders/renderFinal.vert", "Rendering/Cubemap/shaders/renderFinal.frag");
        ...
        public void RenderFrame()
        {
            ...
            shaderRender.Use();
            shaderRender.SetUniform("projection", SceneManager.ActiveScene.activeCam.ProjectionMatrix);
            shaderRender.SetUniform("view", SceneManager.ActiveScene.activeCam.ViewMatrix);
        ...
        public struct RetangularToCubemap
        {
            ...
            {
                shader = new ShaderProgram("Rendering/Cubemap/shaders/cubemap.vert", "Rendering/Cubemap/shaders/rectangular_to_cubemap.frag");
        ...
        public struct IrradianceMap
        {
            ...
            {
                shaderIrradiance = new ShaderProgram("Rendering/Cubemap/shaders/cubemap.vert", "Rendering/Cubemap/shaders/irradiance.frag");
        ...
        public struct PreFilterMap
        {
            ...
            {
                prefilterShader = new ShaderProgram("Rendering/Cubemap/shaders/cubemap.vert", "Rendering/Cubemap/shaders/prefilter.frag");
