...
namespace MyGame.BloomStages
{
    ...
    public class BloomFirstStage
    {
        ...
        {
            mDownsampleShader = new ShaderProgram("Rendering/Bloom/shadersBloom/bloom.vert", "Rendering/Bloom/shadersBloom/downscale.frag");
            mUpsampleShader = new ShaderProgram("Rendering/Bloom/shadersBloom/bloom.vert", "Rendering/Bloom/shadersBloom/upscale.frag");
