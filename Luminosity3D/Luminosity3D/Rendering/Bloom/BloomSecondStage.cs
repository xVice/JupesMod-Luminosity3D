...
namespace Luminosity3D.Rendering.Bloom
{
    class BloomSecondStage : IDisposable
    {
        ...
        public BloomSecondStage(int NumBlomMips)
        {
            ...
            shaderBloomFinal = new ShaderProgram("Rendering/Bloom/shadersBloom/bloom.vert", "Rendering/Bloom/shadersBloom/BloomFinal.frag");
